# Freenove FNK0043B - 4WD 麦克纳姆轮 视觉导航系统

基于 **Raspberry Pi 5** + **Freenove FNK0043B** (4WD Mecanum Wheel Smart Car Kit) 的视觉导航系统。
...
|------|------|
| 主控 | Raspberry Pi 5 |
| 底盘 | Freenove FNK0043B (4WD 麦克纳姆轮) |
...
├── navigation.py         # 导航引擎 (PID + 状态机 + 麦轮运动学)
...
FNK0043B 配备 4 个麦克纳姆轮, 支持全向移动:

- `move_forward/backward`: 前进/后退
- `turn_left/right`: 原地旋回
- `strafe_left/right`: 左右横移
- `set_velocity(vx, vy, omega)`: 全向速度分解
